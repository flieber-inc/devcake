...
| [0042](0042-feed-for-readers.md) | The feed for readers: step cards, one fold for the record, one status comment | Proposed — the Dev folder becomes a projection of the record; verification steps listed in the ADR |