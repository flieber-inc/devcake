...
const SUBTITLES = {
  limits: "Policy knobs gather into one draft — nothing applies until you Save",
  "scheduled-tasks":
...
// Settings dispatcher (CAKE-159): how the system behaves — Limits, Scheduled
// Tasks, Profiles & Export. One section per #/settings/<section> view. Per-view
// subtitle states the save regime honestly (Profiles is immediate; Limits and
...
export default function SettingsPage({ section }) {
  ...
  return (
    <div className="space-y-5">
      <PageHeader title={meta.label} subtitle={SUBTITLES[section] || SUBTITLES.limits} />
