...
`continuation_policy` (global, Policies): `auto` (default) —
...
| claude-code 2.1.210 (re-verified 2.1.229) | `-p P --resume SID` | per-invocation → sum |
| codex 0.144.4 (re-verified 0.147.0) | `exec resume THREAD P` | **cumulative** → last-wins |
...
- Implement: `images/common/devcake_dev/harness/continuation.py`,
  ...
  `admin/spa` PoliciesSection/configLabels.
...
- Operator: `11-admin-panel.md` (Policies), `07-dev-runtime.md`
