...
| [0038](0038-devcake-cli-scope-command-surface-and-agent-operability.md) | DevCake CLI: scope, command surface, agent-operability | **Proposed** (2026-08-30) — awaits founder ratification before impl issues; CAKE-175 |
|