...
from ..ports.pmo import CRITICAL_BOUNDED_WAIT_S, PMOTransient, with_pmo_call
...
@with_pmo_call("critical", wait_budget_s=CRITICAL_BOUNDED_WAIT_S)   # ADR-0040: an operator action outranks polls
