...
| [0033](0033-discovery-routing-the-counterflow-lane.md) | Discovery routing: the counterflow lane | Proposed (2026-08-11); fills ADR-0031's `ELEVATED_MARKERS` seam + ADR-0032's deferred cross-subtree lane; STEWARD gains a second propose-only duty |
