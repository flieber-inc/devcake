...
| [0035](0035-memory-notebooks-claims-conveyor-and-scheduled-tasks.md) | Memory-compatible notebooks, the `.claims/` conveyor, and Scheduled Tasks | Accepted (2026-08-14); amends ADR-0020 (memory merge guard) and the ADR-0016 addendum (shared strict knob); build contract = root `PLAN_MEMORY.md`; docs/16 gates "shipped" on the pilot receipts |
