...
class ForgePort(Protocol):
    ...
    # ticket delivery (ADR-0017 addendum, docs/03 §4): close WITHOUT merging
    # once the change set is on the ticket. Idempotent — a closed PR is
    # success; a MERGED one raises ForgeError so a caller can never mistake
    # a merge for a close.
