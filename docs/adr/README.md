...
| [0041](0041-operator-mcp-server.md) | Operator MCP server: the API's own description is the tool catalogue | Proposed (2026-09-06); phase two (a read-only principal) deferred to a debate |