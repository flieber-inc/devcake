...
const EXACT = {
  ...
  "cfg.pmo.team_key": { group: "PMO", label: "Team key", format: orEmpty },
  "cfg.pmo.api_key_env": { group: "PMO", label: "API key env var", format: orEmpty },
  "cfg.poll_interval_seconds": { group: "PMO", label: "Poll interval (s)" },
  "cfg.repo.forge": { group: "Repository", label: "Forge" },
  "cfg.repo.url": { group: "Repository", label: "Repository URL", format: orEmpty },
  "cfg.repo.token_env": { group: "Repository", label: "Token env var", format: orEmpty },
  "cfg.repo.reviewer_token_env": { group: "Repository", label: "Reviewer token env var", format: orEmpty },
  "cfg.auto_merge": {
